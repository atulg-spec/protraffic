...
WSGI_APPLICATION = 'protraffic.wsgi.application'
...
MEDIA_URL="/media/"
MEDIA_ROOT = 'media'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # This is where static files will be collected

...
class Campaigns(models.Model):
    ...
    executable_path = models.CharField(max_length=100, default="C:/Program Files/Google/Chrome/Application/chrome.exe")
    user_Data_Dir = models.CharField(max_length=100, default="C:/Users/Administrator/AppData/Local/Google/Chrome/User Data/Default")
